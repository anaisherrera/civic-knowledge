...
plot_ed <- ggplot(plotdata, 
  ...
  geom_hline(yintercept = mean_cc,
             color = "grey50",
             linetype = "solid") + 
  xlab("Niveles de educación familiar CINE") + ylab("Conocimiento cívico (PV1)")  + ggtitle("CONOCIMIENTO CÍVICO, SEGÚN NIVEL EDUCACIONAL") + theme_classic() +
...
plot_est <- ggplot(data1, aes(x=S_HISEI, y=PV1CIV)) +
  geom_point(color="#535151") + 
  geom_smooth(method=lm, color="#000000", fill="#D1CACA", se=TRUE) + xlab("Estatus ocupacional Padre/Madre") + ylab("Conocimiento cívico (PV1)") + ggtitle("CONOCIMIENTO CÍVICO, SEGÚN ESTATUS 
OCUPACIONAL DE LOS PADRES") + theme_classic() +
...
plot_lib <- ggplot(plotdata, 
  ...
  geom_hline(yintercept = mean_cc,
             color = "grey50",
             linetype = "solid") + 
  xlab("Número de libros en el hogar") + ylab("Conocimiento cívico (PV1)")  + ggtitle("CONOCIMIENTO CÍVICO, SEGÚN LIBROS EN EL HOGAR") + theme_classic() +
    theme(axis.title.x = element_text(hjust = 0.48),
          axis.text.x = element_text(colour = "black", size = 10, angle = 45, hjust = 1),
          plot.title = element_text(family="Times New Roman",hjust=0.5)) + ylim(400,550)
...
plot_intpol <- ggplot(plotdata, 
  ...
  geom_hline(yintercept = mean_cc,
             color = "grey50",
             linetype = "solid") + 
  xlab("Interés político familiar") + ylab("Conocimiento cívico (PV1)")  + ggtitle("CONOCIMIENTO CÍVICO, SEGÚN INTERÉS POLÍTICO 
DE LOS PADRES") + theme_classic() +
    theme(axis.title.x = element_text(hjust = 0.48),
          axis.text.x = element_text(colour = "black", size = 10, angle = 45, hjust = 1),
          plot.title = element_text(family="Times New Roman",hjust=0.5)) + ylim(400,550)
...
plot_ed_dep <- ggplot(data1, aes(m_S_HISCED, m_PV1CIV, shape = factor(cod_depe2a))) + geom_point(aes(colour = factor(cod_depe2a)), size = 3) + xlab("Promedio educación de padres, por escuela") + ylab("Promedio conocimiento cívico, por escuela") + xlim(1,5) + ggtitle("PROMEDIO DE EDUCACIÓN DE LOS PADRES POR 
...
ggsave(plot_ed_dep, file = "../output/graphs/ed_dep_ccivico2016.png",device = "png",width = 20,height = 13,dpi = "retina",units = "cm")
```
...
plot_ed_dep <- ggplot(data2009, aes(m_S_HISCED, m_PV1CIV, shape = factor(IDSTRATEa))) + geom_point(aes(colour = factor(IDSTRATEa)), size = 3) + xlab("Promedio educación de padres, por escuela") + ylab("Promedio conocimiento cívico, por escuela") + xlim(1,5) + ggtitle("PROMEDIO DE EDUCACIÓN DE LOS PADRES POR 
DEPENDENCIA ADMINISTRATIVA DE LA 
ESCUELA Y CONOCIMIENTO CÍVICO
2009") +
  geom_hline(yintercept = mean_cc,
...
ggsave(plot_ed_dep, file = "../output/graphs/ed_dep_ccivico2009.png",device = "png",width = 20,height = 13,dpi = "retina",units = "cm")
```
...
plot_intpol <- ggplot(plotdata, 
  ...
  geom_hline(yintercept = mean_cc,
             color = "grey50",
             linetype = "solid") + 
  xlab("Uso de internet para buscar información sobre temas políticos o sociales") + ylab("Conocimiento cívico (PV1)")  + ggtitle("CONOCIMIENTO CÍVICO, SEGÚN FRECUENCIA DE USO DE INTERNET PARA
BUSCAR INFORMACIÓN SOBRE TEMAS POLÍTICOS O SOCIALES") + theme_classic() +
    theme(axis.title.x = element_text(hjust = 0.48),
          axis.text.x = element_text(colour = "black", size = 10, angle = 45, hjust = 1),
          plot.title = element_text(family="Times New Roman",hjust=0.5)) + ylim(400,550)

ggsave(plot_intpol, file = "../output/graphs/info-int.png",device = "png",width = 20,height = 13,dpi = "retina",units = "cm")
```
