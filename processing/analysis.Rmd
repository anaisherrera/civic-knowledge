...
# Nivel educativo, tipo de dependencia y conocimiento cívico
```{r}
mean_cc <- mean(data1$PV1CIV)
...
ggsave(plot_ed_dep, file = "../output/graphs/ed_dep_ccivico.png",device = "png",width = 20,height = 13,dpi = "retina",units = "cm")
```
