...
#3d. Actitudes hacia la igualdad con grupos étnicos
```{r}
...
#4a. Disposición a la participación formal
```{r}
...
#4b. Disposición a la participación activista no disruptiva
```{r}
...
```
#4c. Disposición a la participación activista disruptiva
```{r}
